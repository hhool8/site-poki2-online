...
const site = {
  ...
  // AdSense is approved and ready to serve ads.
    ...
    schema: [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 8, url: 'https://poki2.online/fgame/cookie-clicker', name: 'Cookie Clicker' },
...
const gamePosts = [
  ...
  {
    slug:      'escape-tsunami-brainrots-online',
    title:     'Escape Tsunami Brainrots Online',
    description: 'Play Escape Tsunami Brainrots Online free — race to outrun a massive tsunami wave alongside viral Brainrot characters in this wild multiplayer survival game. Dash, dodge, and survive!',
    embedUrl:  'https://azgames.io/escape-tsunami-brainrots-online.embed',
    imgUrl:    '/imgs/fgame/escape-tsunami-brainrots-online.png',
    genre:     'IO Multiplayer',
    category:  'Sports & IO',
    players:   'Multiplayer',
    controls:  'Mouse / Keyboard',
  ...
  {
    slug:      'plants-vs-brainrots-online',
    title:     'Plants vs Brainrots Online',
    description: 'Plants vs Brainrots Online is an idle tower-defense game where you plant quirky defenders to stop waves of viral Brainrot characters. Upgrade your plants and fend off the Brainrot invasion!',
    embedUrl:  'https://azgames.io/plants-vs-brainrots-online.embed',
    imgUrl:    '/imgs/fgame/plants-vs-brainrots-online.png',
  ...
  },
  {
    slug:      'wave-road',
    title:     'Wave Road',
    description: 'Play Wave Road free online — ride a morphing wave down a neon road, dodge obstacles, and rack up combos in this hypnotic arcade runner. Fast reflexes and rhythm are your best tools!',
    embedUrl:  'https://azgames.io/wave-road.embed',
    imgUrl:    '/imgs/fgame/wave-road.png',
    genre:     'Arcade Runner',
    category:  'Platformer & Arcade',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    slug:      'run-3d',
    title:     'Run 3D',
    description: 'Play Run 3D free online — sprint through a 3D tunnel in space, avoid gaps and obstacles, and keep running as far as you can in this thrilling endless arcade game.',
    embedUrl:  'https://azgames.io/run-3d.embed',
    imgUrl:    '/imgs/fgame/run-3d.png',
    genre:     'Endless Runner',
    category:  'Platformer & Arcade',
    players:   '1 Player',
  ...
  },
  {
    slug:      'mr-flip',
    title:     'Mr Flip',
    description: 'Play Mr Flip free online — launch Mr Flip into daring backflips and tricks, stick the landing perfectly, and unlock new characters in this addictive arcade stunt game.',
    embedUrl:  'https://azgames.io/mr-flip.embed',
    imgUrl:    '/imgs/fgame/mr-flip.png',
    genre:     'Arcade',
    category:  'Platformer & Arcade',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    slug:      'hoop-legends',
    title:     'Hoop Legends',
    description: 'Play Hoop Legends free online — shoot hoops, pull off trick shots, and dominate the court in this fast-paced basketball arcade game. Aim, time your shot, and become a legend!',
    embedUrl:  'https://azgames.io/hoop-legends.embed',
    imgUrl:    '/imgs/fgame/hoop-legends.png',
    genre:     'Sports / Arcade',
    category:  'Platformer & Arcade',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    slug:      'bricky-blast',
    title:     'Bricky Blast',
    description: 'Play Bricky Blast free online — aim and shoot bricks to clear the board in this satisfying block-breaking puzzle game. Plan your shots and blast through every level!',
    embedUrl:  'https://azgames.io/bricky-blast.embed',
    imgUrl:    '/imgs/fgame/bricky-blast.png',
    genre:     'Puzzle',
    category:  'Puzzle',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    slug:      'golf-puzzle',
    title:     'Golf Puzzle',
    description: 'Play Golf Puzzle free online — guide the ball into the hole using clever shots and obstacles. A relaxing yet brain-teasing mini-golf puzzle game you can play instantly in your browser.',
    embedUrl:  'https://azgames.io/golf-puzzle.embed',
    imgUrl:    '/imgs/fgame/golf-puzzle.png',
    genre:     'Puzzle',
    category:  'Puzzle',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    ...
    description: 'Play Merge Infinity free online — combine matching tiles and numbers to reach infinity in this addictive merge puzzle game. Simple mechanics, endless depth, and satisfying combos await!',
    embedUrl:  'https://azgames.io/merge-infinity.embed',
    imgUrl:    '/imgs/fgame/merge-infinity.png',
    genre:     'Merge / Puzzle',
    category:  'Puzzle',
    players:   '1 Player',
    controls:  'Mouse / Touch',
  ...
  },
  {
    slug:      'trap-the-cat',
    title:     'Trap the Cat',
    description: 'Play Trap the Cat free online — click to place blocks and surround the sneaky cat before it escapes in this classic logic puzzle game. Easy to learn, tricky to master!',
    embedUrl:  'https://azgames.io/trap-the-cat.embed',
    imgUrl:    '/imgs/fgame/trap-the-cat.png',
    genre:     'Logic / Puzzle',
    category:  'Puzzle',
    players:   '1 Player',
    controls:  'Mouse Click',
  ...
  },
  {
    slug:      'snake-arena',
    title:     'Snake Arena',
    description: 'Play Snake Arena free online — grow longer, outsmart rivals, and dominate the arena in this classic-style snake battle. Slither your way to victory, no download needed.',
    embedUrl:  'https://azgames.io/snake-arena.embed',
    imgUrl:    '/imgs/fgame/snake-arena.png',
    genre:     'Arcade',
    category:  'IO Games',
    players:   '1 Player',
  ...
  },
  {
    ...
    description: 'Play Tic Tac Toe IO free online — the classic game reborn with real-time multiplayer battles. Outsmart opponents worldwide in fast, fun matches directly in your browser.',
    embedUrl:  'https://azgames.io/tic-tac-toe-io.embed',
    imgUrl:    '/imgs/fgame/tic-tac-toe-io.png',
    genre:     'Puzzle',
    category:  'Puzzle',
    players:   'Multiplayer',
    controls:  'Mouse / Tap',
  ...
  },
  {
    ...
    description: 'Play Pinball Master free online — smash colorful crystals, unlock monsters, and chase high scores in fast-paced physics-based pinball action. Instant play, no download.',
    embedUrl:  'https://azgames.io/pinball-master.embed',
    imgUrl:    '/imgs/fgame/pinball-master.png',
    genre:     'Arcade',
    category:  'Arcade',
    players:   '1 Player',
    controls:  'Keyboard',
  ...
  },
  {
    ...
    description: 'Play Bowling Master free online — an arcade bowling game that challenges you to clear all the pins with a single throw. Complete round after round in your browser.',
    embedUrl:  'https://azgames.io/bowling-master.embed',
    imgUrl:    '/imgs/fgame/bowling-master.png',
    genre:     'Sports',
    category:  'Sports',
    players:   '1 Player',
    controls:  'Mouse / Tap',
  ...
  },
  {
    ...
    description: 'Play Breakout Racing free online — race against the police, collect coins, and unlock cool cars. Can you help the panda make a clean getaway? Find out in your browser.',
    embedUrl:  'https://azgames.io/breakout-racing.embed',
    imgUrl:    '/imgs/fgame/breakout-racing.png',
    genre:     'Racing',
    category:  'Racing',
    players:   '1 Player',
    controls:  'Arrow Keys',
  ...
  },
  {
    slug:      'loop-breakout',
    title:     'Loop Breakout',
    description: 'Play Loop Breakout free online — a thrilling escape puzzle game. Break out of tricky levels filled with traps, logic challenges, and unexpected twists. No download needed.',
    embedUrl:  'https://azgames.io/loop-breakout.embed',
    imgUrl:    '/imgs/fgame/loop-breakout.png',
    genre:     'Puzzle',
    category:  'Puzzle',
    players:   '1 Player',
    controls:  'Arrow Keys / Mouse',
  ...
  },
  {
    slug:      'retro-blaster',
    title:     'Retro Blaster',
    description: 'Play Retro Blaster free online — pilot a relentless ship, dodge enemies, grab power-ups, and chase high scores in intense retro bullet-hell arcade chaos. Instant play.',
    embedUrl:  'https://azgames.io/retro-blaster.embed',
    imgUrl:    '/imgs/fgame/retro-blaster.png',
    genre:     'Shooter',
    category:  'Action & Shooter',
    players:   '1 Player',
    controls:  'Mouse',
  ...
  },
  {
    slug:      'retro-rush',
    title:     'Retro Rush',
    description: 'Play Retro Rush free online — put your driving skills to the test in engaging retro racing challenges and conquer various racetracks across different locations, no download.',
    embedUrl:  'https://azgames.io/retro-rush.embed',
    imgUrl:    '/imgs/fgame/retro-rush.png',
    genre:     'Racing',
    category:  'Racing',
    players:   '1 Player',
    controls:  'Arrow Keys',
  ...
  {
    slug:      'retro-sports-champion',
    title:     'Retro Sports Champion',
    description: 'Play Retro Sports Champion free online — compete against opponents and win gold medals in track-and-field-style events, starting with the 100m sprint. In your browser now.',
    embedUrl:  'https://azgames.io/retro-sports-champion.embed',
    imgUrl:    '/imgs/fgame/retro-sports-champion.png',
    genre:     'Sports',
    category:  'Sports',
    players:   '1 Player',
    controls:  'Keyboard',
  ...
  },
  {
    slug:      'rooftop-rush',
    title:     'Rooftop Rush',
    description: 'Play Rooftop Rush free online — skate across rooftops, dodge obstacles, escape police helicopters, and collect coins to unlock upgrades in this fast-paced endless runner.',
    embedUrl:  'https://azgames.io/rooftop-rush.embed',
    imgUrl:    '/imgs/fgame/rooftop-rush.png',
    genre:     'Endless Runner',
    category:  'Endless Runner',
    players:   '1 Player',
    controls:  'Arrow Keys / Swipe',
  ...
  },
  {
    slug:      'tower-rise',
    title:     'Tower Rise',
    description: 'Play Tower Rise free online — an arcade tower-stacking game that challenges you to build the highest skyscraper by dropping blocks with perfect timing. No download needed.',
    embedUrl:  'https://azgames.io/tower-rise.embed',
    imgUrl:    '/imgs/fgame/tower-rise.png',
    genre:     'Arcade',
    category:  'Arcade',
    players:   '1 Player',
    controls:  'Mouse / Tap',
